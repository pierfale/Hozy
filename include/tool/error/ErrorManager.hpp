...
#define throw_error_os(CODE_ERR,CODE_OS) {  int var_tmp = CODE_OS;  DebugImpl_unix::genrate_core_dump(); throw Exception(__FILE__, __FUNCTION__, __LINE__, CODE_ERR, var_tmp); }
